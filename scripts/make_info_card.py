"""
Komal — neofetch-style info card SVG
"""
import html, os
...
ROWS = [
    ...
    ("kv", "Focus",   "Machine Learning, GenAI, LLMs"),
    ("kv", "Edu",     "B.Tech CSE, C.V. Raman Global University"),
    ("kv", "Grad",    "Class of 2029 · CGPA: 8.97"),
    ("kv", "Base",    "Bhubaneswar, Odisha, India"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Lang",    "Python, Java, C"),
    ("kv", "Data",    "NumPy, Pandas, Matplotlib, Scikit-Learn"),
    ("kv", "AI/ML",   "Machine Learning, Deep Learning, GenAI (learning)"),
    ("kv", "Tools",   "Git, GitHub, Linux, VS Code, Jupyter"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Strong academic record — CGPA 8.97"),
    ("bul", "Applied Python projects with real-world logic"),
    ("bul", "Building toward AI Engineering & Generative AI"),
]
...
parts.append(f'<text x="{W/2}" y="{TITLEBAR_H/2 + 4}" fill="{MUTED}" font-size="12" '
             f'text-anchor="middle">komal@github: ~$ neofetch</text>')
...
for i, row in enumerate(ROWS):
    ...
    if kind == "host":
        inner = (f'<text x="{KEY_X}" y="{y:.1f}" font-size="14" font-weight="700">'
                 f'<tspan fill="{GREEN}">komal</tspan><tspan fill="{MUTED}">@</tspan>'
